...
@st.cache_resource
def load_model():
    model = AutoModelForZeroShotImageClassification.from_pretrained("openai/clip-vit-base-patch32")  # Replace with a model compatible with Python 3.12
    processor = AutoProcessor.from_pretrained("openai/clip-vit-base-patch32")  # Replace with a processor compatible with Python 3.12
...
# Initialize face detection model [[4]]
